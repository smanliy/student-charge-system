...
let datas = '';
            ...
            setTimeout(function(){
                ...
                for (var m = 0; m < co.length; m++) {
                    ...
                    ming.className = 'name';
                    ming.textContent = co[m].student_Model.name;
                    // 假设每个数据对象都有一个name属性
                    ...
                    for (var n = 0; n < 4; n++) {
                        ...
                        if (n == 0) {
                            clonedBox.textContent = `期数：${co[m].student_Model.periodNum}`;
                        }
                        else if (n == 1) {
                            clonedBox.textContent = `方向：${co[m].student_Model.department}`;
                        }
                        else if (n == 2) {
                            clonedBox.textContent = `职位：${co[m].student_Model.position}`;
                        }
                        else if (n == 3) {
                            clonedBox.textContent = `获奖经历：${co[m].student_Model.awards}`;
                        }
                    }
                            ...
                            button.forEach(function (element) {
                                ...
                                if (elementText == check) {
                                    ...
                                    for (var p = 0; p < 4; p++) {
                                        ...
                                        if (p == 0) {
                                            msg1[0].textContent = `期数：${co[index].student_Model.periodNum}`;
                                        }
                                        else if (p == 1) {
                                            msg1[1].textContent = `方向：${co[index].student_Model.department}`;
                                        }
                                        else if (p == 2) {
                                            msg1[2].textContent = `职位：${co[index].student_Model.position}`;
                                        }
                                        else if (p == 3) {
                                            msg1[3].textContent = `获奖经历：${co[index].student_Model.awards}`;
                                        }
                                    }
                                    name1[0].textContent = co[index].student_Model.name;
                                    ...
                                    dele_verify.onclick = function(){
                                        window.acc = co[index].student_Model.account;
        ...
        let search_pop = document.getElementsByClassName('search_pop');
            ...
            for(a = 0;a<co.length;a++){
                names.push(co[a].student_Model.name);
            ...
            sousuo.forEach(function (ele,index1) {
                ...
                if(search_text == ele){
                    ...
                    msg2[0].textContent = `期数：${co[index1].student_Model.periodNum}`;
                
                
                    msg2[1].textContent = `方向：${co[index1].student_Model.department}`;
                
                
                    msg2[2].textContent = `职位：${co[index1].student_Model.position}`;
                
                
                    msg2[3].textContent = `获奖经历：${co[index1].student_Model.awards}`;
